...
class WeatherManager {
    func getCurrentWeather(lat: CLLocationDegrees, long: CLLocationDegrees) async throws -> ResponseBody {
        let API_KEY = "6fbbfe6ec6f1ef6e9c4adeb7f5cd9bc5"
        guard let url = URL (string: "https://api.openweathermap.org/data/2.5/weather?lat=\(lat)&lon=\(long)&appid=\(API_KEY)") else {fatalError("Missing URL")}
